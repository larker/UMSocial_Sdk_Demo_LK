...
{
    // 分享转发数据设置
    NSString *shareText = @"自定义分享数据lk";
    NSString *shareUrl = @"http://www.larkersos.com";
    LKShareView *shareView = [[LKShareView alloc] initWithShareText:shareText shareUrl:shareUrl];
...
{    
    ...
    */
    ...
    if (presentSnsIcon) {
        ...
        // 默认列表形式
        [UMSocialSnsService presentSnsController:self appKey:useAppkey shareText:shareText shareImage:shareImage shareToSnsNames:nil delegate:nil];
    }
    // 切换模式
    presentSnsIcon = !presentSnsIcon;
